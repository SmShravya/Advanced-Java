...
// Step2: Create servlet class and use WebServlet annotation
@WebServlet("/CookieServlet")
public class CookieServlet extends HttpServlet {

    /** Counts how many times the page has been loaded *during this JVM lifetime*. */
    private int count = 0;   // count for loading times

    // Step3: Handle GET requests
    @Override
    protected void doGet(HttpServletRequest request,
        ...
        // Step4: Create or retrieve cookies
        String userName = request.getParameter("userName");
        if (userName != null && !userName.isEmpty()) {
            // Create a new cookie
            Cookie userCookie = new Cookie("user", userName);

            // Step5: Set cookie properties
            userCookie.setMaxAge(60);  // Cookie expires in 1 minute
            userCookie.setPath("/");

            // Step6: Add cookie to response
            response.addCookie(userCookie);
        }

        // Step7: Read existing cookies
        ...
        // Step9: (Optional) Add option to delete cookie
        /*
    ...
    // Step10: Handle POST requests (for logout)
    @Override
